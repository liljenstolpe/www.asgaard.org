...
BLOGROLL = [
    ...
    ('My consulting firm, Erebus Consulting & work--related posts', 
	'http://www.erebus-consulting.com/')
]
...
DEPLOYMENT = {
    ...
    "default": "s3cmd --version; s3cmd sync --delete-removed $OUTPUT_DIR/ $DEPLOY_DIR --access_key=$S3_ACCESS_KEY --secret_key=$S3_SECRET_KEY"
}
